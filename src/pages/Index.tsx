...
const MODE_LABELS: Record<CountMode, string> = {
  1: "Не считать первый день, считать последний (полуоткрытый слева интервал)",
  2: "Не считать первый и последний день (открытый интервал)",
  3: "Считать первый и последний день (замкнутый интервал)",
};
